...
import esCompromise from '../'
import tape from 'tape'
console.log('\n 🥗  - running types-test..\n')

tape('misc functions', function (t) {
  let doc = esCompromise('John and Joe walked to the store')
  ...
  let net = esCompromise.buildNet(matches)
  doc = esCompromise(`so good by now. woo hoo before now. in the 2nd quarter 2022`)
  let sr = doc.sweep(net)

  // lazy
  doc = esCompromise.lazy('hello', 'foo')
